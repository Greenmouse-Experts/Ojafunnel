            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mb-5">
                        <h1 class="display-2 fw-medium">5<i class="bx bx-buoy bx-spin display-3" style="color: #713F93"></i>3</h1>
                        <h4 class="text-uppercase">We will be up in couple of minutes. Thanks for patience.</h4>
