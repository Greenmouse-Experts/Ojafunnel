            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between mt-4">
                        <h4 class="mb-sm-0 font-size-18">{{ $list->name . ": " . trans('messages.export') }}</h4>
                            ...
                            <script>
                                var AcelleExport = {
                                    ...
                                    export: function() {
                                        ...
                                        $.ajax({
                                            url: '{{ route('user.subscriber.dispatchExportJob', ['username' => Auth::user()->username, 'list_uid' => $list->uid]) }}',
                                            type: 'POST',
                                            data: {
                                                '_token': token
                                            },
