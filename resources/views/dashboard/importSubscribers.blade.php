                        ...
                        <div class="form">
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <form id="importForm"
                                            action="{{route('user.dispatchImportJob', ["username" => Auth::user()->username, 'list_uid' => $list->uid])}}" method="POST" enctype="multipart/form-data" class="ajax_upload_form form-validate-jquery">
                                            {{ csrf_field() }}

                                            <div class="alert alert-info">
                                                {!! trans('messages.list.import.instruction', [
                                                    'csv_link' => url('files/csv_import_example.csv'),
                                                    'size' => \App\Library\Tool::maxFileUploadInBytes()
                                                ]) !!}
                                            </div>
                                            ...
                                            <div class="upload_file before">
                                                ...
                                                @if (\App\Models\Setting::get('import_subscribers_commitment'))
                                                    <div class="mt-5">
                                                        @include('helpers.form_control', [
                                                            'type' => 'checkbox2',
                                                            'class' => 'policy_commitment mb-4 required',
                                                ...
                                                <div class="text-left">
                                                    <button class="btn btn-secondary mt-4"><i class="icon-check"></i> {{ trans('messages.import') }}</button>
                                                </div>
                                                <br />
                                            </div>
                            ...
                            file_download
                                                    ...
                                                    <a href="#retry" class="btn btn-link me-2 retry"><span class="material-icons-outlined">
                            restart_alt
                            ...
                            <script>
                                var AcelleImport = {
                                    ...
                                    upload: function() {
                                        ...
                                        //console.log(formData) // Make the upload form and submit
