    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.user.update.list', Crypt::encrypt($list->id)) }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="col-lg-12 mb-4">
                                        ...
                                        <input type="text" name="name" class="form-control"  value="{{$list->name ?? ''}}" placeholder="Enter list name" required />
                                    </div>
                                    <div class="col-lg-12 mb-4">
                                        ...
                                        <input type="text" name="display_name" class="form-control" value="{{$list->display_name}}" placeholder="Enter display name" required />
                                    </div>
                                    <div class="col-lg-12 mb-4">
                                        ...
                                        <input type="text" name="slug" class="form-control" value="{{$list->slug}}" placeholder="Enter url slug" required />
                                    </div>
                                </div>
                                <div class="col-md-6" style="border-left: 1px solid gainsboro; padding: 50px;">
                                    <div class="col-lg-12 mb-4">
                                        ...
                                        <textarea type="text" name="description" class="form-control" value="{{$list->description}}" placeholder="Enter description" required>{{$list->description}}</textarea>
                                    </div>
