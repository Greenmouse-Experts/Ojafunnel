            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between mt-4">
                        <h4 class="mb-sm-0 font-size-18">{{ $list->name . ": " . trans('messages.import') }}</h4>
                    ...
                    <h2 class="text-primary my-4"><span class="material-icons-outlined">
                        people
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <form id="importForm"
                                        action="{{ route('user.subscriber.dispatchImportJob', ['username' => Auth::user()->username, 'list_uid' => $list->uid]) }}" method="POST" class="ajax_upload_form form-validate-jquery">
                                        {{ csrf_field() }}
