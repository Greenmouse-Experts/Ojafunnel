        ...
        <div class="row begin card mt-1">
          <div class="col-lg-12 account-head">
            <div class="row align-items-center">
              ...
              <div class="col-md-2">
                <nav aria-label="Page navigation example normal">
                  <ul class="pagination">
                    <li class="page-item">
                      <a class="page-link" href="{{route('user.email.campaign')}}" aria-label="Previous">
            ...
            <div class="row mt-2 mb-4">
              ...
              <div
                class="col-sm-2 col-md-3 text-purp py-2"
                style="border-bottom: 1px solid #713f93;"
              >
                <a href="">
                  Template Gallery
                </a>
              </div>
              <div class="col-sm-2 col-md-3 text-purpp py-2" >
                Layouts
              </div>
              ...
              <div class="mb-2 mt-3">
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="founds">
                      ...
                      <div class="p-2">
                        <p class="font-500 my-1">Welcome Onboard</p>
                        <p class="my-1">Education</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="founds">
                      <div class="found-top"></div>
                      <div class="p-2">
                        <p class="font-500 my-1">Newsletter</p>
                        <p class="my-1">Marketing</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
                ...
                <nav aria-label="Page navigation example normal">
                  <ul class="pagination mt-4">
                    ...
                    <li class="page-item"><a class="page-link" href="#">1</a></li>
                    <li class="page-item">
                      <a class="page-link" href="{{route('user.email.layout')}}" aria-label="Next">
                        <span aria-hidden="true">&raquo;</span>
                      </a>
                    </li>
                  </ul>
