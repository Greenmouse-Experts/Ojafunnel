        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between mt-4">
                        <h4 class="mb-sm-0 font-size-18">{{ trans('messages.sending_domains') }}</h4>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2>
                        <span class="text-semibold"><i class="icon-list2 me-2"></i> {{ trans('messages.domains') }}</span>
                    </h2>
                    ...
                    <form class="listing-form"
                        sort-url="{{ route('user.sending-domain.sort', Auth::user()->username) }}"
                        data-url="{{ route('user.sending-domain.listing', Auth::user()->username) }}"
                        per-page="{{ \App\Models\SendingDomain::$itemsPerPage }}"
                    >
                                    ...
                                    <div class="filter-box">
                                        ...
                                        <div class="dropdown list_actions" style="display: none">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" link-confirm="{{ trans('messages.delete_sending_domains_confirm') }}" href="{{ route('user.sending-domain.delete', Auth::user()->username) }}"><span class="material-icons-outlined">
                delete_outline
                ...
                search
                            ...
                            {{-- @if (Auth::user()->customer->can('create', new Acelle\Model\SendingDomain())) --}}
                                <div class="text-end">
                                    <a href="{{ route('user.sending-domain.create', Auth::user()->username) }}" role="button" class="btn btn-secondary">
                                        <span class="material-icons-round">
                add
                    ...
                    <script>
                        var SendingDomainsIndex = {
                            getList: function() {
                                return makeList({
                                    url: '{{ route('user.sending-domain.listing', Auth::user()->username) }}',
