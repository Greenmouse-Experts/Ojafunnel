                            ...
                            <table class="table align-middle mb-0 table-nowrap">
                                ...
                                <tbody>
                                    @if(count($lmss) > 0)
                                        @foreach($lmss as $lms)
                                            @php
                                            if($lms->scores <= 3) $status = "<font style='color:red'>(Failed)</font>";
                                            else if($lms->scores <= 5) $status = "<font style='color:orange'>(Passed)</font>";
                                            else if($lms->scores > 5) $status = "<font style='color:green'>(Excellent)</font>";
                                            ...
                                            <tr class="table-{{ $lms->id }}">
                                                ...
                                                <td>
                                                    <h5 class="font-size-14 text-truncate"><a href="{{ $quiz_id }}/create-quiz-{{ $lms->session }}" class="text-dark">{{ ucwords($lms->quiz_titles) }} ({{ $lms->course_title }})</a></h5>
                                                </td>
                                                <td>
                                                    <div class="font-size-14">{{ $lms->scores * 10 }}% {!! $status !!}</div>
                                                </td>
