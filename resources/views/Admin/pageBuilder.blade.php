                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="template-listing">
                                    <div class="template-listing-grid">
                                        ...
                                        <div class="single-template">
                                            <h6 class="text-center pageName">{{$page->name}} 
                                                @if($page->published == false)
                                                    <a href="{{route('admin.page.publish', ['Publish', $page->id])}}"><i class="bi bi-check2-all text-white"></i></a>
                                                @else
                                                    <a href="{{route('admin.page.publish', ['Unpublish', $page->id])}}"><i class="bi bi-eye-slash-fill text-white"></i></a>
                                                @endif
                                            </h6>
                                            <div class="inner second-grid">
                                                ...
                                                <div class="start-template">
                                                    ...
                                                    <a class="btn btn-primary d-block mt-2" href="{{route('admin.page.builder.view.editor', Crypt::encrypt($page->id))}}">
                                                        Use Template
                                                    </a>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="Edit-level">
                                                                <form method="POST" action="{{ route('admin.page.builder.update', Crypt::encrypt($page->id))}}" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <div class="form">
                                                                        <div class="col-lg-12">
                                                                            <label>Title</label>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content pb-3">
                                                ...
                                                <div class="modal-body ">
                                                    <div class="row">
                                                        <div class="Editt">
                                                            <form method="POST" action="{{ route('admin.page.builder.delete', Crypt::encrypt($page->id))}}">
                                                                @csrf
                                                                <div class="form">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content pb-3">
            ...
            <div class="modal-body ">
                <div class="row">
                    <div class="Editt">
                        <form method="POST" action="{{route('admin.page.builder.create')}}">
                            {{ csrf_field() }}
                            <div class="form">
                                <p>
                                    <b>
