...
Vvveb.Blocks.add("custom/feature-1", {
    name: "Feature 1",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
    image: "/builder/libs/builder/custom/images/feature-1.PNG",
    html: ` 
    <section data-name="custom-feature-1">  
...
Vvveb.Blocks.add("custom/feature-2", {
    name: "Feature 2",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
    image: "/builder/libs/builder/custom/images/feature-2.PNG",
    html: `
    <section data-name="custom-feature-2"> 
...
Vvveb.Blocks.add("custom/feature-3", {
    name: "Feature 3",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
    image: "/builder/libs/builder/custom/images/feature-3.PNG",
    html: `
    <section data-name="custom-feature-3"> 
        <div class="container px-4 py-5" id="custom-cards">
            <h2 class="pb-2 border-bottom">Custom cards</h2>
            <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
            <div class="col">
                <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('/builder/libs/builder/custom/assets/unsplash-photo-1.jpg');">
            ...
            <div class="col">
                <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('/builder/libs/builder/custom/assets/unsplash-photo-2.jpg');">
                <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
            ...
            <div class="col">
                <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('/builder/libs/builder/custom/assets/unsplash-photo-3.jpg');">
...
Vvveb.Blocks.add("custom/feature-4", {
    name: "Feature 4",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
    image: "/builder/libs/builder/custom/images/feature-4.PNG",
    html: `
    <section data-name="custom-feature-4"> 
...
Vvveb.Blocks.add("custom/feature-5", {
    name: "Feature 5",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
    image: "/builder/libs/builder/custom/images/feature-5.PNG",
    html: `
    <section data-name="custom-feature-5"> 
