...
@section('content')
	<div class="row">
        <div class="col-md-12">
            ...
            <form enctype="multipart/form-data" action="{{ route('user.campaign.resend', ['username' => Auth::user()->username, "uid" => $campaign->uid]) }}" method="POST" class="resend-form form-validate-jqueryx">
                {{ csrf_field() }}
