                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                        ...
                                                        @if($list->status == true)
                                                        <li><a class="dropdown-item" href="{{route('user.disable.list', Crypt::encrypt($list->id))}}">Disactivate</a></li>
                                                        @else
                                                        <li><a class="dropdown-item" href="{{route('user.enable.list', Crypt::encrypt($list->id))}}">Activate</a></li>
                                                        @endif
