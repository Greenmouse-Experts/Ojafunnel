    ...
    <script>
        ...
        $( document ).ready(function() {
            editor = new Editor({
                ...
                url: '{{ route('user.campaign.templateContent', ['username' => Auth::user()->username, 'uid' => $campaign->uid]) }}',
                ...
                uploadAssetUrl: '{{ route('user.template.uploadTemplateAssets', ['username' => Auth::user()->username, 'uid' => $campaign->template->uid]) }}',
                uploadAssetMethod: 'POST',
                saveUrl: '{{ route('user.campaign.templateEdit', ['username' => Auth::user()->username, 'uid' => $campaign->uid]) }}',
                saveMethod: 'POST',
                ...
                logo: '{{ \App\Models\Setting::get('site_logo_small') ? action('SettingController@file', \App\Models\Setting::get('site_logo_small')) : URL::asset('images/logo_light_blue.svg') }}',
                backgrounds: [
