...
<head>
    ...
    <body data-new-gr-c-s-check-loaded="14.1119.0" data-gr-ext-installed="" data-new-gr-c-s-loaded="14.1096.0">
        <!-- Page Content -->
        <div class="container">
        <div class="row">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div style="padding: 20px; border: 1px solid #eee; margin: 10px;">$content</div>
            </form>
          </div>
        </div>
