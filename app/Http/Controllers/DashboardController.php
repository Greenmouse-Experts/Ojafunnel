...
class DashboardController extends Controller
{
    ...
    {
        $promotions = Promotion::latest()->where('promoter_id', Auth::user()->id)->with(['storeOwner', 'store', 'order', 'transaction'])->get();
        ...
        $coursePromotions = CoursePromotion::latest()->where('promoter_id', Auth::user()->id)->with(['shopOwner', 'shop', 'order', 'transaction'])->get();
    ...
    {
        $promotions = Promotion::latest()->where('store_owner_id', Auth::user()->id)->where('status', '!=', 'pending')->with(['storeOwner', 'store', 'order', 'transaction'])->get();
        $coursePromotions = CoursePromotion::latest()->where('shop_owner_id', Auth::user()->id)->where('status', '!=', 'pending')->with(['shopOwner', 'shop', 'order', 'transaction'])->get();
