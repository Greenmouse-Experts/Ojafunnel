                            ...
                            <div class="p-3 text-dark">
                                ...
                                <div class="list">
                                    <ul class="list-unstyled hstack gap-3 mb-0">
                                        ...
                                        <li title="Edit">
                                            <a data-bs-toggle="modal" data-bs-target="#Editing" class="btn btn-sm btn-soft-info"><i class="mdi mdi-pencil-outline"></i></a>
                                        </li>
                                        <li title="Delete">
                                            <a href="#jobDelete" class="btn btn-sm btn-soft-danger"><i class="mdi mdi-delete-outline"></i></a>
                                        </li>
                                    </ul>
                                </div>
                                @endif
...
<!-- Edit Input modal -->
<div class="modal fade" id="Editing" tabindex="-1" aria-labelledby="subscribeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-bottom-0">
                <h5 class="modal-title" id="staticBackdropLabel">
                        ...
                        <form>
                            <div class="form">
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            <input type="text" placeholder="Your Site Name" name="name" class="input" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            <input type="file"  name="name" class="input" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            <textarea cols="5" rows="10" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            <input type="text" placeholder="Enter URL" name="name" class="input" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row justify-content-between">
