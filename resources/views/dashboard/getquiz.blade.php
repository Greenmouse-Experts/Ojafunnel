            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between mt-4">
                        <h4 class="mb-sm-0 font-size-18">Set Quiz</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{route('user.dashboard', Auth::user()->username)}}">Home</a></li>
                                <li class="breadcrumb-item active">Set Quiz</li>
                            </ol>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="campaign-nav mt-1">
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="px-3 py-2">
                                                <a href="{{route('user.course.summary', Auth::user()->username)}}" class="text-decoration-none text-dark">Summary >></a>
                                            </li>
                                            <li class="px-3 py-2">
