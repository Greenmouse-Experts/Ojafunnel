            ...
            <table class="table text-center">
              ...
              <tbody>
                <tr>
                  ...
                  <td>120</td>
                  <td>
                    <a href="{{route('user.store', Auth::user()->username)}}" class="text-decoration-underline"
                      >Preview</a
                    >
                  </td>
                  <td>
                    <div class="d-flex justify-content-center">
                      <ul class="list-unstyled d-flex">
                        <li class="px-1">
                          <a href="{{route('user.my.store', Auth::user()->username)}}" class="text-decoration-none"
                            >View Shop</a
                          >
                        </li>
                        <li class="px-1">
    ...
    <div class="container-fluid mt-5">
      <div class="row text-center bg-white mt-5">
        <div class="text-center py-4">
          ...
          {{config('app.name')}} | All Right Reserved
        </div>
      </div>
    </div>
  </footer>
