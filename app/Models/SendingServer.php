...
class SendingServer extends Model implements HasQuotaInterface
{
    ...
    {
        return $this->hasMany('App\Models\TrackingLog', 'sending_server_id')->orderBy('created_at', 'asc');
    }
    ...
    {
        return $this->belongsToMany('App\Models\Plan', 'plans_sending_servers');
    }
    ...
    {
        return $this->hasMany('App\Models\PlansSendingServer', 'sending_server_id');
    }
    ...
    {
        return $this->belongsTo('App\Models\BounceHandler');
    }

    public function sendingDomains()
    {
        return $this->hasMany('App\Models\SendingDomain', 'sending_server_id');
    }
    ...
    {
        return $this->hasMany('App\Models\Sender', 'sending_server_id');
    }
    ...
    public function sendTestEmail($params)
    {
        ...
        $message->setId($msgId);
        $message->getHeaders()->addTextHeader('X-App-Message-Id', $msgId); // this header is required for SendGrid API sending server
    ...
    public static function select2($request)
    {
        ...
        // plan
        if ($request->plan_uid) {
            $plan = \App\Models\Plan::findByUid($request->plan_uid);
    ...
    public function allowVerifyingOwnDomains()
    {
        ...
        return array_key_exists('allow_verify_domain_against_App', $options) && $options['allow_verify_domain_against_App'] == 'yes';
    }
    ...
    public function allowVerifyingOwnEmails()
    {
        ...
        return array_key_exists('allow_verify_email_against_App', $options) && $options['allow_verify_email_against_App'] == 'yes';
    }
