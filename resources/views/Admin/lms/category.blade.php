...
<div class="main-content">
                                            ...
                                            <td>
                                                <ul class="list-unstyled hstack gap-1 mb-0">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#editCat"  class="btn btn-sm btn-soft-primary"><i class="mdi mdi-eye-outline"></i></a>
                                                    </li>
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deleteCat" class="btn btn-sm btn-soft-danger"><i class="bi bi-x-circle"></i></a>
                                                    </li>
                                                </ul>
                                            </td>
                                        </tr>
    ...
    <div class="modal fade" id="editCat" tabindex="-1" aria-labelledby="categoryModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header border-bottom-0">
                    <h5 class="modal-title" id="staticBackdropLabel">
    ...
    <div class="modal fade" id="deleteCat" tabindex="-1" aria-labelledby="subscribeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class='row justify-content-between p-3'>
                    ...
                    <div class='col text-end'>
                        <button type="button" class="btn px-4" data-bs-dismiss="modal" aria-label="Close" style="color: #ffffff; background-color: #714091">Delete</button>
                    </div>
                </div>
            </div>
        </div>
