...
Vvveb.Blocks.add("custom/list-1", {
    name: "List 1",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
    image: "/builder/libs/builder/custom/images/list-1.PNG",
    html: `
    <section data-name="custom-list-1">
...
Vvveb.Blocks.add("custom/list-2", {
    name: "List 2",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
    image: "/builder/libs/builder/custom/images/list-2.PNG",
    html: `
    <section data-name="custom-list-2"> 
        <div class="list-group">
...
Vvveb.Blocks.add("custom/list-3", {
    name: "List 3",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
    image: "/builder/libs/builder/custom/images/list-3.PNG",
    html: `
    <section data-name="custom-list-3"> 
        <div class="list-group">
            <label class="list-group-item d-flex gap-2">
...
Vvveb.Blocks.add("custom/list-4", {
    name: "List 4",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
    image: "/builder/libs/builder/custom/images/list-4.PNG",
    html: `
    <section data-name="custom-list-4"> 
        <div class="list-group">
...
Vvveb.Blocks.add("custom/list-5", {
    name: "List 5",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
    image: "/builder/libs/builder/custom/images/list-5.PNG",
    html: `
    <section data-name="custom-list-5"> 
...
Vvveb.Blocks.add("custom/list-6", {
    name: "List 6",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
    image: "/builder/libs/builder/custom/images/list-6.PNG",
    html: `
    <section data-name="custom-list-6"> 
