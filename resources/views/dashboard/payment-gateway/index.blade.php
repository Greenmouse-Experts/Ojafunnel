    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="card account-head">
                        <div class="all-create" style="margin-bottom: 0px !important;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="circle">
                                                <img src="{{ $gateway->logo ? URL::asset($gateway->logo) : URL::asset(strtolower($gateway->name) . '.png') }}" draggable="false" alt="{{ $gateway->name }}" width="100px">
                                                <span class="text-dark">{{ $gateway->name }} <span class="badge @if($gateway->status == 'Active') bg-success @else bg-danger @endif rounded-pill" style="color: #ffffff !important;">{{$gateway->status}} </span></span>
                                            </div>
...
<!-- modal -->
<div class="modal fade" id="addModel" tabindex="-1" aria-labelledby="subscribeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-bottom-0">
                <h5 class="modal-title" id="staticBackdropLabel">
                    Choose gateway to be added
                </h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="Edit-level">
                        <form method="POST" action="{{ route('userPaymentGateway')}}">
                            @csrf
                            <div class="form">
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            <select name="name" class="input status">
                                                <option value="">-- Select Payment Gateway --</option>
                                                <option value="Paystack" @foreach($gateways as $gateway) @if($gateway->name == 'Paystack') disabled @endif @endforeach>Paystack</option>
                                                <option value="Flutterwave" @foreach($gateways as $gateway) @if($gateway->name == 'Flutterwave') disabled @endif @endforeach>Flutterwave</option>
                                                <option value="Paypal" @foreach($gateways as $gateway) @if($gateway->name == 'Paypal') disabled @endif @endforeach>Paypal</option>
                                                <option value="Stripe" @foreach($gateways as $gateway) @if($gateway->name == 'Stripe') disabled @endif @endforeach>Stripe</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="Edit-level">
                        <form method="POST" action="{{ route('userUpdatePaymentGateway')}}">
                            @csrf
...
<script>
    ...
    function fetchGatewayDetails(gatewayId) {
        $.ajax({
            method: 'GET',
            url: '/user/view/payment/gateway/' + gatewayId, // Replace with your actual backend endpoint
