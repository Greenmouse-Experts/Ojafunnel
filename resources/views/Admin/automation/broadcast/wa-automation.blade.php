                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content pb-3">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="Editt">
                                                                        <form action="{{ route('admin.whatsapp.update-wa-number') }}" method="POST">
                                                                            @csrf
                                                                            <div class="form">
                                                                                <div class="row">
                                                    ...
                                                    <div class="modal fade" id="delete-{{ $whatsapp_number['id'] }}" tabindex="-1" aria-labelledby="subscribeModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" style="max-width: 35%">
                                                            <div class="modal-content pb-3">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="Editt">
                                                                        <form action="{{ route('admin.whatsapp.delete-wa-number') }}" method="POST">
                                                                            @csrf
                                                                            <div class="form">
                                                                                <div class="row">
...
<div class="modal fade" id="addWANumber" tabindex="-1" aria-labelledby="subscribeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content pb-3">
            ...
            <div class="modal-body">
                <div class="Editt">
                    <form action="{{ route('admin.whatsapp.create-wa-number') }}" method="POST">
                        @csrf
                        <div class="form">
                            <div class="row">
                                <div class="col-lg-12 mb-4">
...
<script>
    async function generateQR(full_jwt_session, id) {
        ...
        let {
            data
        } = await axios.post("{{ route('admin.whatsapp.wa-number-generate-qr') }}", {
            full_jwt_session
        })
        ...
        if (data.status == "QRCODE") {
            ...
            if (session) {
                window.location.assign("{{ route('admin.wa-automation') }}")
            } else await generateQR(full_jwt_session, id)
        }

        if (data.status == "CONNECTED") window.location.assign("{{ route('admin.wa-automation') }}")
    }
    ...
    async function disconnectWA(full_jwt_session, id) {
        ...
        let {
            data
        } = await axios.post("{{ route('admin.whatsapp.wa-number-logout-session') }}", {
            full_jwt_session
        })

        if (data.status == true && data.message == 'Session successfully closed') window.location.assign("{{ route('admin.wa-automation') }}")
    }
    ...
    async function checkSessionConnection(seconds, full_jwt_session, id) {
        return new Promise((resolve, reject) => {
            return setTimeout(async () => {
                ...
                let {
                    data
                } = await axios.post("{{ route('admin.whatsapp.wa-number-check-session-connection') }}", {
                    full_jwt_session
                })
