            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between mt-4">
                        <h4 class="mb-sm-0 font-size-18">Email Lists</h4>
                ...
                <div class="col-lg-12">
                    <div class="card account-head">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="py-2">
                                    <h4 class="font-500">Email Lists</h4>
                                    <p>
                                        All user Email Lists in one Place
                                    </p>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                        <li><a class="dropdown-item" href="{{route('admin.email-marketing.email-lists.view', Crypt::encrypt($list->id))}}" style="cursor: pointer;">View</a></li>
                                                        @if($list->status == true)
                                                        <li><a class="dropdown-item" href="{{route('admin.email-marketing.email-lists.disactivate', Crypt::encrypt($list->id))}}">Disactivate</a></li>
                                                        @else
                                                        <li><a class="dropdown-item" href="{{route('admin.email-marketing.email-lists.activate', Crypt::encrypt($list->id))}}">Activate</a></li>
                                                        @endif
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content pb-3">
                                                            ...
                                                            <div class="modal-body ">
                                                                <div class="row">
                                                                    <div class="Editt">
                                                                        <form method="POST" action="{{ route('admin.email-marketing.email-lists.delete', Crypt::encrypt($list->id))}}">
                                                                            @csrf
                                                                            <div class="form">
                                                                                <p><b>Delete List</b></p>
                                                                                <div class="row">
