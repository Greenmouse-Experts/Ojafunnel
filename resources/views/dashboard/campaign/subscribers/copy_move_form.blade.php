...
<div id="copy-move-subscribers-form" class="">
            <form action="{{ route("user.subscriber." . request()->action, Auth::user()->username) }}" method="POST" class="form-validate-jquery">
                {{ csrf_field() }}
                ...
                @endforeach
                    ...
                    @include('helpers.form_control', [
                        ...
                        'value' => 'update',
                        'options' => App\Models\Subscriber::copyMoveExistSelectOptions(),
                        'rules' => []
                    ])
