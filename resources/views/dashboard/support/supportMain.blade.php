            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="aller">
                            <iframe src="{{App\Models\ExplainerContent::where('menu', 'Support')->first()->video}}" title="Dummy Video For YouTube API Test" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
