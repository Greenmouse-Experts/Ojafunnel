    ...
    public static function defaultSettings()
    {
        return [
            ...
            'url_open_track' => [
                'cat' => 'url',
                'value' => '',
                // action('CampaignController@open', ["message_id" => trans("messages.MESSAGE_ID")]),
                'type' => 'text',
                'not_required' => true,
            ],
            'url_click_track' => [
                'cat' => 'url',
                'value' => '',
                // action('CampaignController@click', ["message_id" => trans("messages.MESSAGE_ID"), "url" => trans("messages.URL")]),
                'type' => 'text',
                'not_required' => true,
            ],
            'url_delivery_handler' => [
                'cat' => 'url',
                'value' => '',
                // action('DeliveryController@notify'),
                'type' => 'text',
                'not_required' => true,
            ],
            'url_update_profile' => [
            ...
            'geoip.engine' => [
                'cat' => 'others',
                'value' => 'sqlite',
                # available values are sqlite|nekudo|mysql
                'type' => 'text',
                'not_required' => true,
            ],
            'geoip.enabled' => [
            ...
            'geoip.sqlite.source_url' => [
                'cat' => 'others',
                'value' => 'https://Appmail.s3.amazonaws.com/ip2locationdb11.db',
                'type' => 'text',
                'not_required' => true,
            ],
