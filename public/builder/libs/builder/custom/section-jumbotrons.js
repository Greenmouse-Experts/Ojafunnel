Vvveb.SectionsGroup["Jumbotrons"] = [
    "custom/jumbotron-1",
    "custom/jumbotron-2",
    "custom/jumbotron-3",
    "custom/jumbotron-4",
...
Vvveb.Sections.add("custom/jumbotron-1", {
    name: "Jumbotron 1",
...
Vvveb.Sections.add("custom/jumbotron-2", {
    name: "Jumbotron 2",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
...
Vvveb.Sections.add("custom/jumbotron-3", {
    name: "Jumbotron 3",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
...
Vvveb.Sections.add("custom/jumbotron-4", {
    name: "Jumbotron 4",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',
