...
@section('content')
	...
	<div class="row">
        <div class="col-md-12 template-list-container">
            ...
            @include('dashboard.campaign.automation2.email.template._tabs')
...
search
    ...
    <script>
		var listTheme = makeList({
            url: '{{ route('user.automation.templateLayoutList', ['username' => Auth::user()->username,'uid' => $automation->uid,'email_uid' => $email->uid]) }}',
