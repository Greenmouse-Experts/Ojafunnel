...
Route::prefix('user')->group(function () {
    ...
    Route::get('/page/builder/save/page/{id}', [App\Http\Controllers\PageController::class, 'page_builder_save_page'])->name('user.page.builder.save.page');
    ...
    Route::get('/funnel/builder/save/page/{id}', [App\Http\Controllers\PageController::class, 'funnel_builder_save_page'])->name('user.funnel.builder.save.page');
