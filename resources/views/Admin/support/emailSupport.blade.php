...
<div class="main-content">
                ...
                <div class="email-msg-box">
                    <div class='bg-white email-box' data-bs-toggle="modal" data-bs-target="#viewMail">
                        <div class="d-flex">
                            ...
                            <div class=''>
                                <div class=''>
                                    <p class='p-0 m-0 fw-bold'>Sent from Greenmouse</p>
                                </div>
                                <div>
                        ...
                        <div class=''>
                            <div class='bg-light email-img-box' data-bs-toggle="modal" data-bs-target="#replyMail">
    ...
    <div class="modal fade" id="replyMail" tabindex="-1" aria-labelledby="subscribeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header border-bottom-0">
                    <h5 class="modal-title" id="staticBackdropLabel">
