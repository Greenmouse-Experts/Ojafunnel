<div class="image_upload_div">
  <form action="{{ route('user.campaign.uploadAttachment', ['username' => Auth::user()->username, 'uid' => $campaign->uid]) }}" enctype="multipart/form-data" class="dropzone">
     {{ csrf_field() }}
  </form>
</div>
      ...
      @foreach ($campaign->getAttachments() as $k=>$filename)
        ...
        <li class="d-flex align-items-canter py-2 border-top">
          <div class="d-flex align-items-center mr-auto">
            <span class="material-icons-outlined fs-4 text-muted me-3 d-block">
              attach_email
            </span>
          ...
          <div class="text-nowrap">
            <a title="" class="tip-right" href="{{ route('user.campaign.downloadAttachment', [
            ...
            |
            <a href="{{ route('user.campaign.removeAttachment', [
              'username' => Auth::user()->username,
              'uid' => $campaign->uid,
              'name' => $filename,
