            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="Automation2IndexContainer" class="listing-form"
                        data-url="{{ route('user.automation.listing', Auth::user()->username) }}"
                        per-page="{{ \App\Models\Automation2::ITEMS_PER_PAGE }}"
                    >
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item"
                                                    ...
                                                    href="{{ route('user.automation.enable', Auth::user()->username) }}"
                                                >
