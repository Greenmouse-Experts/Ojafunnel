...
<head>
  <meta charset="utf-8" />
  <title>{{$shop->name}} | Oja Funnel | shopFront</title>
...
<body class="bg-white">
                    ...
                    <div class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton1">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 col-12 text-center checkout">
                                <a href="{{ route('course.cart', $shop->name) }}" class="btn btn-primary btn-block">View all</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="container home-banner-area text-center" style="padding: 130px 0 120px;background: {{$shop->theme}}!important; color: {{$shop->color}}">
        <div class="container">
