...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="listing-form" sort-url="{{ route('sending.server.sort') }}" data-url="{{ route('sending.server.listing') }}" per-page="{{ App\Models\SendingServer::$itemsPerPage }}">
                <div class="d-flex top-list-controls top-sticky-content">
                        ...
                        <div class="filter-box">
                            ...
                            <div class="dropdown list_actions" style="display: none">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" link-confirm="{{ trans('messages.enable_sending_servers_confirm') }}" href="{{ route('sending.server.enable') }}"><span class="material-icons-outlined">
                                                play_arrow
                                            </span> {{ trans('messages.enable') }}</a></li>
                                    <li><a class="dropdown-item" link-confirm="{{ trans('messages.disable_sending_servers_confirm') }}" href="{{ route('sending.server.disable') }}"><span class="material-icons-outlined">
                                                hide_source
                                            </span> {{ trans('messages.disable') }}</a></li>
                                    <li><a class="dropdown-item" link-confirm="{{ trans('messages.delete_sending_servers_confirm') }}" href="{{ route('sending.server.delete') }}"><span class="material-icons-outlined">
                                                delete_outline
                    ...
                    {{-- @if (Auth::user()->admin->can('create', App\Models\SendingServer::class)) --}}
                    <div class="text-end">
                        <a href="{{ route('sending.server.select') }}" role="button" class="btn btn-secondary">
                            <span class="material-icons-round">
                                add
