            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between mt-4">
                        <h4 class="mb-sm-0 font-size-18">{{ $list->name }}</h4>
                            ...
                            <div id="progressBar" class="form-group processing hide">
                                ...
                                <div class="form-group finish hide">
                                    <div class="text-left">
                                        ...
                                        <a id="retryBtn" href="retryBtn" class="btn bg-grey-600 me-2 retry"><span class="material-icons-outlined">
                                            restart_alt
                    ...
                    <div class="row" id="verifyForm">
                        <div class="col-md-6">
                            ...
                            <p>{!! trans('messages.verification_process_not_running', [
                                ...
                                'total' => \App\Library\Tool::format_number($list->readCache('SubscriberCount')),
                            ]) !!}</p>
                            <p>
                                <a link-confirm="{{ trans('messages.reset_list_verification_confirm') }}" link-method="POST" class="btn btn-secondary"
                                    href="{{ route("user.list.resetVerification", ['username' => Auth::user()->username, 'uid' => $list->uid]) }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <script>
                                ...
                                var EmailVerificationChart = {
                                    url: '{{ route('user.list.emailVerificationChart', ['username' => Auth::user()->username, 'uid' => $list->uid]) }}',
                                    getChart: function() {
                    ...
                    <script>
                        var AcelleList = {
                            ...
                            start: function() {
                                ...
                                $.ajax({
                                    url: '{{ route('user.list.startVerification', ['username' => Auth::user()->username, 'uid' => $list->uid ] ) }}',
                                    type: 'POST',
                                    data: {
                                        '_token': token,
                            ...
                            cancel: function() {
                                ...
                                $.ajax({
                                    ...
                                    success: function(result, textStatus, jqXHR) {
                                        ...
                                        window.location.href = '{{ route("user.list.verification", ['username' => Auth::user()->username, "uid" => $list->uid ]) }}';
                                    }
                                }).fail(function(jqXHR, textStatus, errorThrown) {
                                    alert(errorThrown);
