    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between mt-4">
                        <h4 class="mb-sm-0 font-size-18">Paypal</h4>
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{route('user.add.paypal')}}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6" style="display: flex; align-items: center; flex-wrap: wrap;">
                                    <div style="padding: 3rem;">
                                        ...
                                        <h4 style="font-weight: 700;">Add Paypal Details</h4>
                                ...
                                <div class="col-md-6" style="border-left: 1px solid gainsboro; padding: 50px;">
                                    ...
                                    <div class="col-lg-12 mb-4">
                                        ...
                                        <input type="text" name="email" class="form-control" placeholder="Enter paypal email" required />
                                    </div>
                                    <div class="col-lg-12 mb-4">
                                        <label for="">By adding this paypal method of payment you are confirming that you are the owner and have full authorization to this details.</label>
                                    </div>
