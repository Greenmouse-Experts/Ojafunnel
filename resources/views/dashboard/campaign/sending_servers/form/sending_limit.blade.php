...
@section('content')
    <div class="mc_section">
        <form id="sendingLimitForm" action="{{ route('user.sending-server.sendingLimit', ['username' => Auth::user()->username, 'uid' => ($server->uid ? $server->uid : 0)]) }}" method="POST">
            {{ csrf_field() }}
            ...
            <div class="row boxing">
                ...
                <div class="col-md-4">
                    @include('helpers.form_control', ['type' => 'select',
                        ...
                        'options' => \App\Models\Plan::quotaTimeUnitOptions(),
