...
<div class="main-content">
    <div class="page-content">
        ...
        <div class="container-fluid">
            <!-- start page title -->
            <div class="row">
                <div class="col-lg-10 account-head">
                ...
                <div class="col-lg-1 account-head">
                    <div class="card begin">
                        <div class="card-body">
                            <!-- <p class="cash">Explainer Video Here</p> -->
                            @if(App\Models\ExplainerContent::where('menu', 'Upgrade')->exists())
                    ...
                    <div class="message upgrade-single">
                        ...
                        <div class="js-price-big-wrapper-month">
                            ...
                            @if($allmonthlyplan != null)
                                ...
                                @else
                                    @if($singleplan->name == 'Free')
                                    <a href="#" class="upgrade-btn" style="background: rgb(255, 255, 255); border: 3px solid rgb(0, 160, 255); color: rgb(0, 160, 255);">Free Plan</a>
                                    @else
                        ...
                        <div class="js-price-big-wrapper">
                            ...
                            @if($allyearlyplan != null)
                                ...
                                @else
                                    @if($singleplan->name == 'Free')
                                    <a href="#" class="-yearly -hide upgrade-btn" style="background: rgb(255, 255, 255); border: 3px solid rgb(0, 160, 255); color: rgb(0, 160, 255);">Free Plan</a>
                                    @else
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="aller">
                            <iframe src="{{App\Models\ExplainerContent::where('menu', 'Upgrade')->first()->video}}" title="Dummy Video For YouTube API Test" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="aller">
                            <p>
                                {{App\Models\ExplainerContent::where('menu', 'Upgrade')->first()->text}}
                            </p>
                        </div>
                    </div>
                </div>
