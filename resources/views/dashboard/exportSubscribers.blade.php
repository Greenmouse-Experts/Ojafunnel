                ...
                <div class="col-lg-12">
                    <div class="Edit">
                        <div class="form">
                            <div class="row">
                                <p class="tell mb-4">
                                    <b class="mb-sm-0 font-size-15">Export subscribers</b>
                                </p>
                                <div class="row">
                                    <div class="col-md-6">
                                        <p>
                                            <b>Select what do you want to export then click the Export button below to start export.</b>
                                        </p>
                                        <p class="sending">
                                            Whole list (0 subscribers)
                                             <input type="checkbox">
                                        </p>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <label>Choose segment<span>*</span> </label>
                                    <div class="row">
