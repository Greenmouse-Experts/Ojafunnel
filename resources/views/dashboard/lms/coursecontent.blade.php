        ...
        <div class="container-fluid">
            ...
            <div class="checkout-tabs mb-4">
                <div class="row">
                    ...
                    <div class="col-xl-2">
                        <div class="card">
                            <a href="{{route('user.save.course', Crypt::encrypt($course->id))}}" onclick="event.preventDefault();
                                document.getElementById('submit-button').submit();" value="save-draft" class="btn px-4 py-1" style="color: #714091; border: 1px solid #714091">
                                Save
                            </a>
                        </div>
                    </div>
                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="v-pills-shipping" role="tabpanel" aria-labelledby="v-pills-shipping-tab">
                                            ...
                                            <div class="common mt-5">
                                                <div class="assets">
                                                    <h1><b id="inline-section" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-type="text" class="text-dark" data-pk="1" data-title="Enter username">Section {{$loop->iteration}}:</b> {{$section->title}}</h1>
                                                    <form class="form" method="post" action="{{route('user.save.lesson', Crypt::encrypt($section->id))}}">
                                                        @csrf
                                                        <div class="actting">
                                                            <h1><b>Lesson</b>
                                                                <div class="lamet float-end"><a href="" data-bs-toggle="modal" data-bs-target="#createLesson"><strong><u>Create Lesson</u></strong></a></div>
                                                            </h1>
                                                            <div class="form">
                                                                <div class="col-md-12 mb-4">
                                                                    <input type="text" name="lesson_title" placeholder="Enter Lesson Title">
                                                                </div>
                                                                <div class="col-md-12 mb-4">
                                                            ...
                                                            <div class="float-end tent">
                                                                <div class="btn-group">
                                                                    <a class="btn dropdown-toggle btn-sm" data-bs-toggle="dropdown" aria-expanded="false">
                                                                        <b><i class="bi bi-plus-lg"></i> Content</b>
                                                                    </a>
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" href="#" onclick="morevideo()">Video</a>
                                                                        <a class="dropdown-item" href="#" onclick="morequiz()">Quiz</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="morevidoes" id="morevideos" style="display: none !important;">
                                                            <div class="row">
                                                        ...
                                                        <div class="morevidoes" id="morequizs" style="display: none !important;">
                                                            <div class="row">
                                                                <div class="col-sm-12 mb-2">
                                                                    <p>Quiz </p>
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="Edit-level">
                                                                            <form method="post" action="{{route('user.save.curriculum', Crypt::encrypt($section->id))}}">
                                                                                @csrf
                                                                                <div class="form">
                                                                                    <div class="col-lg-12">
                                                                                        <label>Title</label>
                                                                                    ...
                                                                                    <div class="col-lg-12">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-12 mb-4">
                                                                                                <select name="content_type" id="selectBox" onchange="changeFunc();" multiple>
                                                ...
                                                <div style="display: flex; justify-content: space-between;" class="mt-3">
                                                    <div class="">
                                                        <input style="background-color: #70418F; color:#fff; width: 70%" data-repeater-create class="btn" value="+ Section " />
                                                    </div>
                                                    <div class="">
                                                        <input style="background-color: #70418F; color:#fff; width: 70%" data-repeater-delete class="btn" value="- Section" />
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-2 mb-4">
                                                                        ...
                                                                        <select name="currency">
                                                                            <option value="{{$course->level}}">{{$course->currency}}</option>
...
<script>
    function video() {
        ...
        var quiz = document.getElementById("quizs");
    ...
    function morevideo() {
        var video = document.getElementById("morevideos");
        var quiz = document.getElementById("morequizs");
        if (video.style.display === "none") {
            video.style.display = "block";
            quiz.style.display = "none";
        } else {
